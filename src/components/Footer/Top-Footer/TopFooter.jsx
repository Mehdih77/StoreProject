...
export default function TopFooter() {
    ...
    <div className='container top-footer-icons' > 
        ...
        <p>
            <i className="fab fa-cc-paypal goods-icon"></i>
            <span>امکان پرداخت در محل
            </span>
        </p>
        <p>
            <i className="fas fa-exchange-alt goods-icon"></i>
            <span>7روز ضمانت تعویض
            </span>
        </p>
        <p>
            <i className="fas fa-gem goods-icon"></i>
            <span>ضمانت اصل بودن کالا
            </span>
        </p>
        <p>
            <i className="fas fa-headset goods-icon"></i>
            <span>
                7روز هفته، 24ساعته
            </span>
        </p>
