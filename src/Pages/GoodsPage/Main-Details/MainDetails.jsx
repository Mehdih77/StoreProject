    ...
    return (
      <section className='container-fluid MainDetails-goodspage'>
           ...
           <div className='col-6 col-md-1 goodspage-icons'>
                <ul>
                    <li><i title='افزودن به علاقه مندی ها' className="far fa-heart"></i></li>
                    <li><i title='اشتراک گذاری' className="fas fa-share-alt"></i></li>
                    <li><i title='اطلاع رسانی' className="far fa-bell"></i></li>
                    <li><i title='نمودار قیمت' className="far fa-chart-bar"></i></li>
                </ul>
            </div>
...
گالری تصاویر
  ...
  <SwiperSlide><img className='img-fluid' src="/image/phone-26.jpg" /></SwiperSlide>
            ...
            <div className='col-md-5'>
                ...
                <p>ویژگی های محصول:</p>
                    <li><i className="fas fa-circle"></i>حافظه داخلی: {phone.storage}</li>
                    <li><i className="fas fa-circle"></i>شبکه های ارتباطی: {phone.contact} </li>
                    <li><i className="fas fa-circle"></i>دوربین‌های پشت گوشی: {phone.camera}</li>
                    <li><i className="fas fa-circle"></i>سیستم عامل: {phone.sistem}</li>
                    <li><i className="fas fa-circle"></i>توضیحات سیم کارت: {phone.simcart}</li>
                </ul>
            
            <p className='goods-warning'><i className="fas fa-exclamation-circle"></i>هشدار سامانه همتا: حتما در زمان تحویل دستگاه، به کمک کد فعال‌سازی چاپ شده روی جعبه یا کارت گارانتی، دستگاه را از طریق #7777*، برای سیم‌کارت خود فعال‌سازی کنید. آموزش تصویری در آدرس اینترنتی hmti.ir/05</p>
            
            <div className='post-free'>
                <div>
                    <p className='post-free-title'><i className="fas fa-truck"></i>ارسال رایگان سفارش
            ...
            <div className='col-md-3 goodspage-buy'>
                ...
                <div className='shop-rating'>
                    <p className='shop-rating-name'><i className="fas fa-store shop-rating-icon"></i>آنلاین شاپ</p>
                    <div>
                    <p className='shop-rating-top-total-percent'>92.7%</p>
                        ...
                        <div className="progress shop-rating-progress">
                                                <div className="progress-bar" style={{width:'60%'}} role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                                                <div className="progress-bar" style={{width:'30%'}} role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                                                <div className="progress-bar" style={{width:'10%'}} role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
    ...
    <div className='shop-rating-percent'>
        ...
        <div>
            ...
            <p className='shop-rating-percent-2'> بدون ثبت مرجوعی </p>
                ...
                <p className='shop-name'><i className="fas fa-store"></i>آنلاین شاپ</p>
                <p className='shop-like'><span>100% </span>رضایت خریداران | عملکرد <span>عالی</span></p>
                </div>
                <div className='shop-guaranty'>
                    <p><i className="fas fa-award"></i>گارانتی 18 ماهه آنلاین شاپ</p>
                </div>
                <div className='shop-post'>
                    <p><i className="fas fa-shipping-fast"></i>موجود در انبار فروشنده</p>
                </div>
